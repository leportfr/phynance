...
inputTrueData = np.array([np.array(dfTrue).astype(np.float64).T[0,-(history_len+train_len+1):] for i in range(mini_batch_size)])
...
print 'ave yearly test return', (np.average(ideal_test_return)/1.e5)**(365./100)
